...
public class RoomAddedCardRecyclerViewAdapter extends RecyclerView.Adapter<RoomAddedCardRecyclerViewAdapter.RoomAddedCardViewHolder> {

    private List<RoomModel> roomsList;
    private StepRoomsFragment fragment;

    public RoomAddedCardRecyclerViewAdapter(List<RoomModel> listData, StepRoomsFragment fragment) {
    ...
    @NonNull
    @Override
    public RoomAddedCardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.ui_card_wizard_rooms_selected, parent, false);
        return new RoomAddedCardViewHolder(layoutView);
    }

    @Override
    public void onBindViewHolder(@NonNull RoomAddedCardViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RoomAddedCardRecyclerViewAdapter.this.notifyDataSetChanged();
                RoomAddedCardRecyclerViewAdapter.this.notifyItemRemoved(position);
            }
        });
    }
    ...
    public static class RoomAddedCardViewHolder extends RecyclerView.ViewHolder {
        ...
        public RoomAddedCardViewHolder(@NonNull View itemView) {
            super(itemView);
            ...
            icon = itemView.findViewById(R.id.wiz_room_minus_icon);
        }
    }
     ...
     *
     */
    private void setNoDataWarning(@NonNull RoomAddedCardViewHolder holder){
    ...
    public void setRoomsList(List<RoomModel> newList){
        roomsList = newList;
    }
